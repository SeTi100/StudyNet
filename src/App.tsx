...
import { VirtualizedPdfViewer, VirtualizedPdfViewerRef } from './components/pdf/VirtualizedPdfViewer';
import { SearchBar } from './components/search/SearchBar';
import { NotesEditor } from './components/notes/NotesEditor';
import { CitationListView } from './components/citations/CitationListView';
        ...
        <div className="flex-1 min-h-0 flex overflow-hidden">
          {!activeDoc ? (
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center text-neutral-500">
              ...
              <button
                onClick={() => fileInputRef.current?.click()}
                className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold rounded-lg shadow flex items-center gap-2 transition-colors"
              >
                <Upload className="w-4 h-4" />
            ...
            <>
              ...
              {(activeTab === 'split' || activeTab === 'pdf') && (
                <div className={`h-full ${activeTab === 'split' ? 'w-3/5' : 'w-full'} min-w-0`}>
                  {activePdfDoc ? (
              ...
              {(activeTab === 'split' || activeTab === 'notes') && (
                <div className={`h-full ${activeTab === 'split' ? 'w-2/5' : 'w-full'} min-w-0`}>
